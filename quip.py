...
def get_html(thread: dict):
    """
    Get HTMLSource From Quip API by Quip ID
    :param thread:
    :return:
    """
    html = thread['html']
    html = html.replace('src=\'', 'src=\'https://quip.com').replace('\n', '')
    return html
...
class QuipClient(object):
    ...
    def __init__(self, access_token=None, client_id=None, client_secret=None,
        ...
        OAuth endpoint.
        """
        self.access_token = os.environ.get('QUIP_ACCESS_TOKEN')
